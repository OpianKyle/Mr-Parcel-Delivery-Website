...
export default function CalculatorPage() {
  ...
  return <main className="container-wide py-8 sm:py-12">
    <div className="mb-9 flex flex-col justify-between gap-5 lg:flex-row lg:items-end"><div><p className="eyebrow">Customer quote</p><h1 className="display-heading mt-5 max-w-2xl text-5xl text-[#08263d] sm:text-6xl">Know the cost <span className="text-[#f36f21]">before it moves.</span></h1><p className="mt-4 max-w-xl leading-7 text-[#527080]">Build a clear quote for one parcel or a full shipment. Every parcel and price stays visible.</p></div><div className="flex items-center gap-2 rounded-xl border border-[#d7e0dc] bg-white px-4 py-3 text-xs font-bold text-[#527080]"><Check size={16} className="text-[#0d634f]" /> Indicative quote</div></div>
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_390px]">
      <form onSubmit={calculate} className="space-y-5">
        ...
        <button type="submit" className="btn-primary w-full sm:w-auto"><Gauge size={17} /> Calculate my quote <ArrowRight size={17} /></button>
      </form>
