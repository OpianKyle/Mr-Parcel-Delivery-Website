  ...
  return (
    <PageFrame>
      <section className="dark-panel relative overflow-hidden">
        <div className="absolute -right-28 top-16 h-72 w-72 rounded-full bg-[#0f5b83]/45 blur-3xl" />
        <div className="container-wide relative grid items-center gap-10 py-14 sm:py-20 lg:grid-cols-[1.03fr_.97fr] lg:gap-4 lg:py-24">
          <div>
            <RouteRibbon />
            <h1 className="display-heading reveal reveal-1 mt-5 max-w-3xl text-[3.5rem] text-[#fffaf1] sm:text-[5.5rem] lg:text-[6.2rem]">MR <span className="text-[#f36f21]">PARCEL</span></h1>
            <p className="reveal reveal-2 mt-6 max-w-xl font-display text-2xl font-extrabold leading-tight tracking-[-.04em] text-[#fffaf1] sm:text-3xl">Mini Parcel Delivery Services</p>
            <p className="reveal reveal-2 mt-2 max-w-xl text-lg leading-8 text-[#c5d8dc]">Fast, Reliable & Same-Day Delivery!</p>
            <p className="reveal reveal-2 mt-2 text-sm font-bold text-[#f7a061]">Serving the West Coast & Cape Town</p>
            ...
            <div className="reveal reveal-4 mt-8 flex items-center gap-3 text-xs font-bold text-[#9bb6c0]"><Check size={16} className="text-[#f36f21]" /> Local & efficient, without the courier maze</div>
          </div>
          <div className="reveal reveal-3 lg:pl-4"><VanIllustration /></div>
        </div>
        <div className="border-t border-[#214b63]">
          <div className="container-wide grid grid-cols-2 gap-5 py-5 text-xs font-bold text-[#9db9c4] sm:grid-cols-4">
        ...
        <div className="container-wide">
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-3">
            {serviceCards.map(({ icon: Icon, title, body }, index) => (
              <article key={title} className={`paper-panel soft-shadow rounded-2xl p-6 ${index === 1 ? 'md:translate-y-7' : ''}`} data-testid={`card-home-benefit-${index}`}>
                <div className="grid h-12 w-12 place-items-center rounded-xl bg-[#b9e4df] text-[#08263d]"><Icon size={23} /></div>
      ...
      <section className="grid-paper section-pad overflow-hidden bg-[#dcece8]">
        <div className="container-wide grid items-center gap-10 lg:grid-cols-[.86fr_1.14fr]">
          <div>
          ...
          <div className="relative space-y-4">
            {[
              ...
              <div key={number} className="flex gap-5 rounded-2xl border border-[#bfd5d2] bg-[#fffaf1]/70 p-5 sm:items-center" data-testid={`card-home-step-${number}`}>
                <span className="font-display text-3xl font-extrabold text-[#f36f21]">{number}</span>
        ...
        <div className="container-wide">
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-[1.1fr_.9fr]">
            ...
            <div className="grid gap-5">
              <article className="paper-panel rounded-2xl p-7" data-testid="card-service-business"><div className="grid h-11 w-11 place-items-center rounded-xl bg-[#fbe1d2] text-[#f36f21]"><Box size={22} /></div><h3 className="font-display mt-6 text-2xl font-extrabold tracking-[-.05em]">For local businesses</h3><p className="mt-3 text-sm leading-6 text-[#527080]">Keep customers happy with a practical way to send orders, samples, stock and documents around the region.</p></article>
...
function RouteDiagram() {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-[#dcece8] p-4 sm:p-8" data-testid="visual-route-map">
    ...
    <PageFrame>
      ...
      <section className="section-pad bg-[#fffaf1]">
        <div className="container-wide grid items-start gap-10 lg:grid-cols-[1.05fr_.95fr]">
          <form className="paper-panel soft-shadow rounded-2xl p-6 sm:p-9" onSubmit={submit} data-testid="form-book-delivery">
    ...
    <PageFrame>
      ...
      <section className="section-pad bg-[#fffaf1]">
        <div className="container-narrow">
          <div className="orange-panel hard-shadow rounded-2xl p-7 sm:p-12">
